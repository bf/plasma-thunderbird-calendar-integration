...
#include <memory>
#include "../../../thunderbirdeventsplugin/connection.h"
...
QT_MOC_LITERAL(3, 25, 4) // "data"
    ...
    "Connection\0dataReceived\0\0data"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dataReceived((*reinterpret_cast< const QJsonObject(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Connection::*)(const QJsonObject & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Connection::dataReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Connection::dataReceived(const QJsonObject & _t1)
{
