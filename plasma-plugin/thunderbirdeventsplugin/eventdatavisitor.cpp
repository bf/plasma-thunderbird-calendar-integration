...
#include "thunderbirddatasource.h"
#include "thunderbirdeventsplugin_debug.h"

BaseEventDataVisitor::BaseEventDataVisitor(ThunderbirdDataSource *dataSource, QDate start, QDate end)
...
EventDataVisitor::EventDataVisitor(ThunderbirdDataSource *dataSource, const QDate &start, const QDate &end)
...
EventDataIdVisitor::EventDataIdVisitor(ThunderbirdDataSource *dataSource, QDate start, QDate end)
    : BaseEventDataVisitor(dataSource, start, end)
{
}
