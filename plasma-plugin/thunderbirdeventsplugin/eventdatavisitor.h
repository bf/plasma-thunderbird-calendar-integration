...
protected:
    BaseEventDataVisitor(ThunderbirdDataSource *dataSource, QDate start, QDate end);
...
{
public:
    EventDataVisitor(ThunderbirdDataSource *dataSource, const QDate &start, const QDate &end);
...
{
public:
    explicit EventDataIdVisitor(ThunderbirdDataSource *dataSource, QDate start, QDate end);
