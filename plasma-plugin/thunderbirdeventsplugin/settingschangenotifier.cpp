...
#define APP_PROPERTY_NAME "ThunderbirdEventsPluginSettingsChangeNotifier"

// Q_LOGGING_CATEGORY(THUNDERBIRDEVENTSPLUGIN_LOG, "THUNDERBIRDEVENTSPLUGIN_LOG");
...
SettingsChangeNotifier::SettingsChangeNotifier(QObject *parent)
    : QObject(parent)
{
    qCDebug(THUNDERBIRDEVENTSPLUGIN_LOG) << this << "created";
}
